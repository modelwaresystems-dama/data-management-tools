...
POLICY_CONTROLS = {'TR-EDS-01': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'Reviewing practices against preferred ethics identifies and records practice gaps.'},
 'TR-EDS-02': {'controls': [('PD-SYN-DHE', 'C10'), ('PD-SYN-DHE', 'C17')],
               'why': 'The step identifies the ethics principles and assesses ethics risk factors.'},
 'TR-EDS-03': {'controls': [('PD-SYN-DHE', 'C01'), ('PD-SYN-DHE', 'C10')],
               'why': 'The strategy drafts the ethics policies and the corporate ethics statement.'},
 'TR-EDS-04': {'controls': [('PD-SYN-DHE', 'C01'), ('PD-SYN-DHE', 'C10')], 'why': 'Approval covers the ethics policies and the statement of principles.'},
 'TR-EDS-05': {'controls': [('PD-SYN-DHE', 'C01')], 'why': 'Rejection is the negative outcome of the policy approval act.'},
 'TR-EDS-06': {'controls': [('PD-SYN-DHE', 'C01'), ('PD-SYN-DHE', 'C10'), ('PD-SYN-DHE', 'C13')],
               'why': 'Policies and statements are published and compliance monitoring and reporting start.'},
 'TR-EDS-07': {'controls': [('PD-SYN-DHE', 'C16')], 'why': 'An alignment review on a recorded trigger is the on-change policy review.'},
 'TR-EDS-08': {'controls': [('PD-SYN-DHE', 'C01'), ('PD-SYN-DHE', 'C16')], 'why': 'The review closes with approval and publication of the realigned policies.'},
 'TR-EDS-09': {'controls': [('PD-SYN-DHE', 'C01')], 'why': 'Retirement reverses the policy approval of the strategy.'},
 'TR-GAP-01': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'Identifying and logging a practice gap is the gap register duty.'},
 'TR-GAP-02': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'Planning remediation with an owner and date is gap treatment.'},
 'TR-GAP-03': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'Executing the remediation treats the gap.'},
 'TR-GAP-04': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'Verifying effectiveness is the gap closure verification.'},
 'TR-GAP-05': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'Failed verification returns the gap to treatment.'},
 'TR-GAP-06': {'controls': [('PD-SYN-DHE', 'C09')], 'why': 'A recurrence reopens the gap in the register.'},
 'TR-GAP-07': {'controls': [('PD-SYN-DHE', 'C09'), ('PD-SYN-DHE', 'C17')], 'why': 'The gap is closed by accepting it as a treated ethics risk with sign-off.'},
 'TR-ECP-01': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'The communication plan sets the audiences for ethics training and expectations.'},
 'TR-ECP-02': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'Developing the training programme is the staff ethics training duty.'},
 'TR-ECP-03': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'Launch starts training and records completion and affirmations.'},
 'TR-ECP-04': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'Rejecting training content returns it within the training duty.'},
 'TR-ECP-05': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'The refresh keeps staff ethics training current.'},
 'TR-ECP-06': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'Completing the refresh renews training and affirmations.'},
 'TR-ECP-07': {'controls': [('PD-SYN-DHE', 'C11')], 'why': 'Retirement reverses the launch of the training programme.'},
 'TR-EUS-01': {'controls': [('PD-SYN-DHE', 'C04')], 'why': 'The intended use is assessed against the ethics principles before approval.'},
 'TR-EUS-02': {'controls': [('PD-SYN-DHE', 'C05')], 'why': 'Setting purpose limits and monitoring conditions forms the conditions of the clearance.'},
 'TR-EUS-03': {'controls': [('PD-SYN-DHE', 'C05')], 'why': 'The governance body grants the ethics clearance under its conditions.'},
 'TR-EUS-04': {'controls': [('PD-SYN-DHE', 'C04')], 'why': 'Declining follows a failed ethical use assessment.'},
 'TR-EUS-05': {'controls': [('PD-SYN-DHE', 'C06')], 'why': 'An incident or change suspends the clearance.'},
 'TR-EUS-06': {'controls': [('PD-SYN-DHE', 'C05'), ('PD-SYN-DHE', 'C06')],
               'why': 'Restoring lifts the suspension once the clearance conditions are reconfirmed.'},
 'TR-EUS-07': {'controls': [('PD-SYN-DHE', 'C06')], 'why': 'An unresolved suspension ends in withdrawal of the clearance.'},
 'TR-EUS-08': {'controls': [('PD-SYN-DHE', 'C05')], 'why': 'Withdrawal on end of purpose or basis reverses the clearance.'},
 'TR-EUS-09': {'controls': [('PD-SYN-DHE', 'C04')], 'why': 'A new purpose is assessed against the ethics principles.'},
 'TR-EUS-10': {'controls': [('PD-SYN-DHE', 'C04')], 'why': 'The revised use is reassessed against the ethics principles.'},
 'TR-EUS-11': {'controls': [('PD-SYN-DHE', 'C05')], 'why': 'Rejecting the proposed conditions is part of the clearance decision.'},
 'TR-ECI-01': {'controls': [('PD-SYN-DHE', 'C07')], 'why': 'A reported breach is logged and triaged as an ethics incident.'},
 'TR-ECI-02': {'controls': [('PD-SYN-DHE', 'C08')], 'why': 'Investigation establishes facts, cause and scope.'},
 'TR-ECI-03': {'controls': [('PD-SYN-DHE', 'C08')], 'why': 'The confirmed breach is remedied as part of incident closure.'},
 'TR-ECI-04': {'controls': [('PD-SYN-DHE', 'C08')], 'why': 'An unconfirmed incident is closed with recorded reasons.'},
 'TR-ECI-05': {'controls': [('PD-SYN-DHE', 'C08')], 'why': 'Closure follows verified remediation.'},
 'TR-ECI-06': {'controls': [('PD-SYN-DHE', 'C07'), ('PD-SYN-DHE', 'C08')], 'why': 'Reopening reverses closure and re-logs the incident for triage.'},
 'TR-ECI-07': {'controls': [('PD-SYN-DHE', 'C08')], 'why': 'Failed verification returns the incident to investigation.'}}
