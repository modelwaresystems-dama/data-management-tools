...
SPEC = {
    ...
    "qaNotes": [
        ...
        {"severity": "note", "rule": "capture", "element": "REG-DS-PRV", "finding": "Data Privacy states (lawful basis, consent, subject requests, retention) are drafted from goals 2 and 3 and the Government regulation requirement source; Howard to confirm the privacy lifecycle against the regulation in scope (for example POPIA, GDPR)."},
